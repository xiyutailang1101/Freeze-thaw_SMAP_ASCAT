...
for site_no in site_nos:
    ...
    tbv0, tbh0, npr0, gau0, ons0 = test_def.main(site_no, ['20160101', '20161225'], sm_wind=7, mode='annual', seriestype='tb')  # result tb
    tbv1, tbh1, npr1, gau1, ons1 = test_def.main(site_no, ['20160101', '20161225'], sm_wind=7, mode='annual')  # result npr
    ...
    plt_npr_gaussian_all([tbv0, tbh0, gau0],  # row 1, tb
                         ...
                         ['SWE (mm)', swe_date-365, swe_daily], onset, figname='all_plot_'+site_no+'.png')  # row 5 swe
