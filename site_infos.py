...
def get_id(id='947', mode='all'):
    site_nos = ['947', '949', '950', '960', '962', '967', '968', '1090', '1175', '1177', '1233', '2065', '2081',
                    '2210', '2211', '2212', '2213', '1183', '961', '952', '957', '948', '1182', '958', '1234', '1232',
                '1266', '987', '1062', '1003', '1064', '1063', '1037', '1092', '1035', '1094',
                '1268', '1055', '1279', '1096', '1093', '1089', '1267', '1091', '954', '1103', '1072']
...
def change_site(site_no, names=False):  # the No, lat and long of each site
    if names is False:
        site_list = [['947', 65.12422, -146.73390], ['948', 65.25113, -146.15133], ['949', 65.07833, -145.87067],
                     ...
                     ['alaska', 63.25, -151.5], ['Tibet', 33.0, 88.0],
                     ['95000', 64.551224000000005, -145.93763000000001],
                     ...
                     ['961', 66+34.0/60, -145-15.0/60], ['1182', 66.92, -151.53], ['1232', 59.42, -161.16],
                     ['1234', 59.13, -159.09], ['1266', 60.98, -153.92], ['987', 59.35, -151.85],
                     ['1062', 59.86, -151.31], ['1003', 59.74, -151.24], ['1064', 59.78, -150.76],
                     ['1063', 59.73, -150.66], ['1037', 59.7, -150.71], ['1092', 60.19, -149.62],
                     ['1035', 61.38, -149], ['1094', 63.31, -147.65], ['1268', 63.2, -145.63],
                     ['1055', 61.19, -145.65], ['1279', 61.16, -145.64], ['1096', 61.35, -142.71],
                     ['1093', 62.07, -142.05], ['1267', 61.75, -150.89], ['1091', 61.79, -149.28],
                     ['1264', 62.13, -147.62], ['954', 60.78, -149.18], ['1103', 60.96, -149.09],
                     ['1072', 63.54, -150.99], ['951', 64.95, -145.52]
                     ] # 957 redo
